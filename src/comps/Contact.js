    ...
    return (
        <>
            <div style={{ marginTop: '5%', marginLeft: '5%', marginRight: '5%' }}>
                ...
                <h4 style={{ textAlign: 'center', marginBottom: '5%' }}>CONTACT US <br></br>________</h4>
                ...
                <div className={classes.root}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} sm={6} >
                            <Paper style={{ backgroundImage: 'linear-gradient(120deg,rgba(0, 0, 0, 0.877), #52acf5)', color: 'white' }} className={classes.paper}>
